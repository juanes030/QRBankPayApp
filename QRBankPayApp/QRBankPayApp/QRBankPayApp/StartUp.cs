...
using QRBankPayApp.Helpers.HttpMessageHandlers;
...
namespace QRBankPayApp
{
    public static class Startup
    {
        ...
        private const string SERVICES_NAMESPACE = "QRBankPayApp.Services";
        //private const string SINGLE_INSTANCE_SERVICES_NAMESPACE = "QRBankPayApp.Services.SingleInstance";
        private const string VIEW_MODELS_NAMESPACE = "QRBankPayApp.ViewModels";
        ...
        static Startup()
        {
            ...
            serviceCollection.AddRefitClient<ITransactionApi>(refitSettings)
              .ConfigureHttpClient(c => c.BaseAddress = new Uri(Settings.ApiBaseUri))
              .AddHttpMessageHandler<BaseAddressHandler>();
